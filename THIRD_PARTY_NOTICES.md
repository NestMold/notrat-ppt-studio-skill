...
Copyright © notrat.cn. Original Notrat PPT Studio materials are licensed under the MIT License and the 2.0 architecture, command gateway, schemas, template catalog runtime, default editable + proactive object-animation policy, and original workflow text.
