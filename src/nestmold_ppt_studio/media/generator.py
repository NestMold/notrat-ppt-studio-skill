...
from .providers import create_image_provider
from .providers.atlascloud import atlascloud_model_for_operation
...
def _ensure_api_key(dry_run: bool) -> None:
    ...
    if base_url:
        command = (
            f'python3 {runtime_script} runtime config --api-key "your-api-key" '
