...
def main() -> int:
    ...
    parser.add_argument("deck", help="Deck directory or deck.manifest.json")
    parser.add_argument("--slide", required=True, help="slide_01 or 1")
    parser.add_argument("--agent-id", required=True)
    parser.add_argument("--agent-nickname")
    parser.add_argument("--prompt-file", help="Prompt file path. Defaults to the job file in deck.manifest.json.")
