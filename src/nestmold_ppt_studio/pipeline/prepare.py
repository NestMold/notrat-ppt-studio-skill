...
def main() -> int:
    ...
    prompts_dir = out_dir / "jobs" / "slides"
    prompts_dir.mkdir(parents=True, exist_ok=True)
    (out_dir / "assets" / "slides").mkdir(parents=True, exist_ok=True)
    ...
    for fallback, slide, number in numbered_slides:
        ...
        final_image = out_dir / "assets" / "slides" / f"{slide_id}.png"
